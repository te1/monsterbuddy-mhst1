export default {
  ...
  head: {
    ...
    meta: [
      ...
      },
      {
        hid: 'twitter:image',
        name: 'twitter:image',
        content: 'https://mhst1.monsterbuddy.app/icon.png',
      },
      {
    ...
    script: [
      {
        defer: true,
        'data-domain': 'mhst1.monsterbuddy.app',
  ...
  sitemap: {
    hostname: 'https://mhst1.monsterbuddy.app',
    trailingSlash: true,
    exclude: [
      '/monsters/filter',
      '/monsties/filter',
    ...
    routes: [
      ...
      { url: '/eggs', priority: 1 },
      { url: '/tower-of-illusion', priority: 1 },
